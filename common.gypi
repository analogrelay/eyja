{
  'variables': {
    ...
    'target_arch%': 'ia32',          # target architecture
    ...
    'configurations': {
      'debug': {
        ...
        'msvs_configuration_attributes': {
          'IntermediateDirectory': '$(SolutionDir)builds\\windows\\$(Configuration)\\obj\\$(ProjectName)\\',
          'OutputDirectory': '$(SolutionDir)builds\\windows\\$(Configuration)\\$(ProjectName)\\',
        }, # msvs_configuration_attributes
        'xcode_settings': {
